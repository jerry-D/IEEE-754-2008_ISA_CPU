...
assign statusRWcollision = rdStatus_q1 && &OPdest_q2[15:8] && (~|OPdest_q2[7:5] || (OPdest_q2[7:3]==5'b10001));
...
assign cmpSE  = ((OPdest_q2[15:0]==cmpSE_ADDRS[15:0])  && ~Ind_Dest_q2 && wrcycl && q2_sel && X_EQ_Y);
assign cmpQE  = ((OPdest_q2[15:0]==cmpQE_ADDRS[15:0])  && ~Ind_Dest_q2 && wrcycl && q2_sel && X_EQ_Y);
assign cmpSNE = ((OPdest_q2[15:0]==cmpSNE_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && ~X_EQ_Y);
assign cmpQNE = ((OPdest_q2[15:0]==cmpQNE_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && ~X_EQ_Y);
assign cmpSG  = ((OPdest_q2[15:0]==cmpSG_ADDRS[15:0])  && ~Ind_Dest_q2 && wrcycl && q2_sel && X_GT_Y);
assign cmpQG  = ((OPdest_q2[15:0]==cmpQG_ADDRS[15:0])  && ~Ind_Dest_q2 && wrcycl && q2_sel && X_GT_Y);
assign cmpSGE = ((OPdest_q2[15:0]==cmpSGE_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && (X_GT_Y || X_EQ_Y));
assign cmpQGE = ((OPdest_q2[15:0]==cmpQGE_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && (X_GT_Y || X_EQ_Y));
assign cmpSL  = ((OPdest_q2[15:0]==cmpSL_ADDRS[15:0])  && ~Ind_Dest_q2 && wrcycl && q2_sel && X_LT_Y);
assign cmpQL  = ((OPdest_q2[15:0]==cmpQL_ADDRS[15:0])  && ~Ind_Dest_q2 && wrcycl && q2_sel && X_LT_Y);
assign cmpSLE = ((OPdest_q2[15:0]==cmpSLE_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && (X_LT_Y || X_EQ_Y));
assign cmpQLE = ((OPdest_q2[15:0]==cmpQLE_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && (X_LT_Y || X_EQ_Y));
assign cmpSNG = ((OPdest_q2[15:0]==cmpSNG_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && ~X_GT_Y);
assign cmpQNG = ((OPdest_q2[15:0]==cmpQNG_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && ~X_GT_Y);
assign cmpSLU = ((OPdest_q2[15:0]==cmpSLU_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && (X_LT_Y || UNORDERED));
assign cmpQLU = ((OPdest_q2[15:0]==cmpQLU_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && (X_LT_Y || UNORDERED));
assign cmpSNL = ((OPdest_q2[15:0]==cmpSNL_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && ~X_LT_Y);
assign cmpQNL = ((OPdest_q2[15:0]==cmpQNL_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && ~X_LT_Y);
assign cmpSGU = ((OPdest_q2[15:0]==cmpSGU_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && (X_GT_Y || UNORDERED));
assign cmpQGU = ((OPdest_q2[15:0]==cmpQGU_ADDRS[15:0]) && ~Ind_Dest_q2 && wrcycl && q2_sel && (X_GT_Y || UNORDERED));
assign cmpQU  = ((OPdest_q2[15:0]==cmpQU_ADDRS[15:0])  && ~Ind_Dest_q2 && wrcycl && q2_sel && UNORDERED);
assign cmpQO  = ((OPdest_q2[15:0]==cmpQO_ADDRS[15:0])  && ~Ind_Dest_q2 && wrcycl && q2_sel && ~UNORDERED);
...
assign Status_wren = ((OPdest_q2[15:0]==ST_ADDRS[15:0]) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b11) && wrcycl && q2_sel);
...
always @(posedge CLK or posedge RESET)
    if (RESET) class <= 4'b0;
    else if ((OPdest_q2[15:0]==clas_ADDRS) && ~Ind_Dest_q2 && wrcycl && q2_sel)
        casex(class_sel)
...
//these five bits can be used as general-purpose status bits if not used as substitution attribute bits, since such function is optional according to the spec
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==setSubstt_ADDRS) && (Size_Dest_q2==2'b01) && ~Ind_Dest_q2)
          {subsInexact, 
...
//these five bits are the "flags"              
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==lowFlg_ADDRS) && ~Ind_Dest_q2) invalid_flag <= wrsrcAdata[0] ? 1'b0 : invalid_flag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasFlg_ADDRS) && ~Ind_Dest_q2) invalid_flag <= wrsrcAdata[0] ? 1'b1 : invalid_flag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rstFlg_ADDRS) && ~Ind_Dest_q2) invalid_flag <= wrsrcAdata[0];                                                                  
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==lowFlg_ADDRS) && ~Ind_Dest_q2) divby0_flag <= wrsrcAdata[1] ? 1'b0 : divby0_flag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasFlg_ADDRS) && ~Ind_Dest_q2) divby0_flag <= wrsrcAdata[1] ? 1'b1 : divby0_flag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rstFlg_ADDRS) && ~Ind_Dest_q2) divby0_flag <= wrsrcAdata[1];                                                                  
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==lowFlg_ADDRS) && ~Ind_Dest_q2) overflow_flag <= wrsrcAdata[2] ? 1'b0 : overflow_flag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasFlg_ADDRS) && ~Ind_Dest_q2) overflow_flag <= wrsrcAdata[2] ? 1'b1 : overflow_flag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rstFlg_ADDRS) && ~Ind_Dest_q2) overflow_flag <= wrsrcAdata[2];                                                                  
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==lowFlg_ADDRS) && ~Ind_Dest_q2) underflow_flag <= wrsrcAdata[3] ? 1'b0 : underflow_flag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasFlg_ADDRS) && ~Ind_Dest_q2) underflow_flag <= wrsrcAdata[3] ? 1'b1 : underflow_flag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rstFlg_ADDRS) && ~Ind_Dest_q2) underflow_flag <= wrsrcAdata[3];                                                                  
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==lowFlg_ADDRS) && ~Ind_Dest_q2) inexact_flag <= wrsrcAdata[4] ? 1'b0 : inexact_flag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasFlg_ADDRS) && ~Ind_Dest_q2) inexact_flag <= wrsrcAdata[4] ? 1'b1 : inexact_flag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rstFlg_ADDRS) && ~Ind_Dest_q2) inexact_flag <= wrsrcAdata[4];                                                                  
...
//these next five bits are "signals"
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==lowSig_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) invalid_signal <= wrsrcAdata[0] ? 1'b0 : invalid_signal;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasSig_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) invalid_signal <= wrsrcAdata[0] ? 1'b1 : invalid_signal;                                                                  
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==lowSig_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) divby0_signal <= wrsrcAdata[1] ? 1'b0 : divby0_signal;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasSig_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) divby0_signal <= wrsrcAdata[1] ? 1'b1 : divby0_signal;                                                                  
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==lowSig_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) overflow_signal <= wrsrcAdata[2] ? 1'b0 : overflow_signal;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasSig_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) overflow_signal <= wrsrcAdata[2] ? 1'b1 : overflow_signal;                                                                  
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==lowSig_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) underflow_signal <= wrsrcAdata[3] ? 1'b0 : underflow_signal;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasSig_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) underflow_signal <= wrsrcAdata[3] ? 1'b1 : underflow_signal;                                                                  
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==lowSig_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) inexact_signal <= wrsrcAdata[4] ? 1'b0 : inexact_signal;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasSig_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) inexact_signal <= wrsrcAdata[4] ? 1'b1 : inexact_signal;                                                                  
...
//alternate Immediate Handler enables    size==01 to clear and size==10 to set
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==enAltImm_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) enAltImmInexactHandl <= wrsrcAdata[4] ? 1'b0 : enAltImmInexactHandl;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==enAltImm_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) enAltImmInexactHandl <= wrsrcAdata[4] ? 1'b1 : enAltImmInexactHandl;                                                                  
 
       if (Status_wren) enAltImmUnderflowHandl <= wrsrcAdata[14];
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==enAltImm_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) enAltImmUnderflowHandl <= wrsrcAdata[3] ? 1'b0 : enAltImmUnderflowHandl;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==enAltImm_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) enAltImmUnderflowHandl <= wrsrcAdata[3] ? 1'b1 : enAltImmUnderflowHandl;                                                                  
 
       if (Status_wren) enAltImmOverflowHandl <= wrsrcAdata[13];
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==enAltImm_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) enAltImmOverflowHandl <= wrsrcAdata[2] ? 1'b0 : enAltImmOverflowHandl;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==enAltImm_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) enAltImmOverflowHandl <= wrsrcAdata[2] ? 1'b1 : enAltImmOverflowHandl;                                                                  
 
       if (Status_wren) enAltImmDivByZeroHandl <= wrsrcAdata[12];
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==enAltImm_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) enAltImmDivByZeroHandl <= wrsrcAdata[1] ? 1'b0 : enAltImmDivByZeroHandl;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==enAltImm_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) enAltImmDivByZeroHandl <= wrsrcAdata[1] ? 1'b1 : enAltImmDivByZeroHandl;                                                                  
 
       if (Status_wren) enAltImmInvalidHandl <= wrsrcAdata[11];
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==enAltImm_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) enAltImmInvalidHandl <= wrsrcAdata[0] ? 1'b0 : enAltImmInvalidHandl;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==enAltImm_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) enAltImmInvalidHandl <= wrsrcAdata[0] ? 1'b1 : enAltImmInvalidHandl;                                                                  

//Raise No Flag
       if (Status_wren) razNoInexactFlag <= wrsrcAdata[20];
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasNoFlag_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) razNoInexactFlag <= wrsrcAdata[4] ? 1'b0 : razNoInexactFlag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasNoFlag_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) razNoInexactFlag <= wrsrcAdata[4] ? 1'b1 : razNoInexactFlag;                                                                  
 
       if (Status_wren) razNoUnderflowFlag <= wrsrcAdata[19];
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasNoFlag_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) razNoUnderflowFlag <= wrsrcAdata[3] ? 1'b0 : razNoUnderflowFlag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasNoFlag_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) razNoUnderflowFlag <= wrsrcAdata[3] ? 1'b1 : razNoUnderflowFlag;                                                                  

       if (Status_wren) razNoOverflowFlag <= wrsrcAdata[18];
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasNoFlag_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) razNoOverflowFlag <= wrsrcAdata[2] ? 1'b0 : razNoOverflowFlag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasNoFlag_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) razNoOverflowFlag <= wrsrcAdata[2] ? 1'b1 : razNoOverflowFlag;                                                                  

       if (Status_wren) razNoDivByZeroFlag <= wrsrcAdata[17];
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasNoFlag_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) razNoDivByZeroFlag <= wrsrcAdata[1] ? 1'b0 : razNoDivByZeroFlag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasNoFlag_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) razNoDivByZeroFlag <= wrsrcAdata[1] ? 1'b1 : razNoDivByZeroFlag;                                                                  

       if (Status_wren) razNoInvalidFlag <= wrsrcAdata[16];
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasNoFlag_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b01)) razNoInvalidFlag <= wrsrcAdata[0] ? 1'b0 : razNoInvalidFlag;                                                                  
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==rasNoFlag_ADDRS) && ~Ind_Dest_q2 && (Size_Dest_q2==2'b10)) razNoInvalidFlag <= wrsrcAdata[0] ? 1'b1 : razNoInvalidFlag;                                                                  
...
//"is(es)" 
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==is_ADDRS) && ~Ind_Dest_q2) begin
...
//class
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==clas_ADDRS) && ~Ind_Dest_q2) begin      
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==tOrd_ADDRS) && ~Ind_Dest_q2) totlOrder <= _totlOrder;
       
       if (Status_wren) totlOrderMag <= wrsrcAdata[52]; 
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==tOrdM_ADDRS) && ~Ind_Dest_q2) totlOrderMag <= _totlOrderMag;      
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==tstFlg_ADDRS) && ~Ind_Dest_q2) aFlagRaised <= _aFlagRaised;      
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==tstSFlg_ADDRS) && ~Ind_Dest_q2) aFlagRaised <= _aSFlagRaised;      
...
//this handles SetBinRndDir, DefaultModes, RestoreModes
       ...
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==setBinRnd_ADDRS) && (Size_Dest_q2==2'b01) && ~Ind_Dest_q2) {RM_ATR_EN, AWAY, RM1, RM0} <= wrsrcAdata[3:0]; //writes to just the RMode  bits
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==setBinRnd_ADDRS) && (Size_Dest_q2==2'b00) && ~Ind_Dest_q2) {RM_ATR_EN, AWAY, RM1, RM0} <= 4'b0;   //restore defaults   
              
//integer & logical status bits
       if (Status_wren) {IRQ_IE, done, V, N, C, Z} <=  {wrsrcAdata[26], wrsrcAdata[4:0]};
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==compare_ADDRS) && (Size_Dest_q2==2'b00) && ~Ind_Dest_q2) begin  //compare only affects Z and V flags
          Z <= (compareAdata==compareBdata);
          V <= (compareAdata < compareBdata);
       end
       else if (wrcycl && q2_sel && (OPdest_q2[15:0]==setDVNCZ_ADDRS) && (Size_Dest_q2==2'b01) && ~Ind_Dest_q2)
          {IRQ_IE,
           done, 
           V,       //  |-- write enable
           N,       //  |                 |-- data to write (if enabled)
           C,       //  v                 v
           Z} <= {(wrsrcAdata[11] ? wrsrcAdata[10] : IRQ_IE),
