...
assign Dest_addrs_q2 = Ind_Dest_q2 ?  DEST_ind_q2 : {15'b0, OPdest_q2[15:0]};
assign Dest_addrs_q0 = Ind_Dest_q0 ?  DEST_ind_q0 : {15'b0, OPdest_q0[15:0]};
...
always @(*) begin
     case (DEST_ARn_sel_q2) 
     	3'b000 : DEST_ind_q2 = (Imod_Dest_q2 && Ind_Dest_q2) ? (AR0[31:0] + {{20{OPdest_q2[14]}}, OPdest_q2[14:3]}) : AR0[31:0]; 
     	3'b001 : DEST_ind_q2 = (Imod_Dest_q2 && Ind_Dest_q2) ? (AR1[31:0] + {{20{OPdest_q2[14]}}, OPdest_q2[14:3]}) : AR1[31:0]; 
     	3'b010 : DEST_ind_q2 = (Imod_Dest_q2 && Ind_Dest_q2) ? (AR2[31:0] + {{20{OPdest_q2[14]}}, OPdest_q2[14:3]}) : AR2[31:0]; 
     	3'b011 : DEST_ind_q2 = (Imod_Dest_q2 && Ind_Dest_q2) ? (AR3[31:0] + {{20{OPdest_q2[14]}}, OPdest_q2[14:3]}) : AR3[31:0];
     	3'b100 : DEST_ind_q2 = (Imod_Dest_q2 && Ind_Dest_q2) ? (AR4[31:0] + {{20{OPdest_q2[14]}}, OPdest_q2[14:3]}) : AR4[31:0]; 
     	3'b101 : DEST_ind_q2 = (Imod_Dest_q2 && Ind_Dest_q2) ? (AR5[31:0] + {{20{OPdest_q2[14]}}, OPdest_q2[14:3]}) : AR5[31:0]; 
     	3'b110 : DEST_ind_q2 = (Imod_Dest_q2 && Ind_Dest_q2) ? (AR6[31:0] + {{20{OPdest_q2[14]}}, OPdest_q2[14:3]}) : AR6[31:0]; 
     	3'b111 : DEST_ind_q2 = (Imod_Dest_q2 && Ind_Dest_q2) ? ( SP[31:0] + {{20{OPdest_q2[14]}}, OPdest_q2[14:3]}) :  (SP[31:0] + {{20{OPdest_q2[14]}}, OPdest_q2[14:3]}); 
     endcase
end
