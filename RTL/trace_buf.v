...
output [63:0] trace_reg0;
output [63:0] trace_reg1;
output [63:0] trace_reg2;
output [63:0] trace_reg3;
...
always @(posedge CLK or posedge RESET) begin
    if (RESET) begin
        ...
        pc_q3 <= pc_q2;
        if (discont_q3) begin
            trace_reg0 <= {32-`PCWIDTH'b0, PC, 32-`PCWIDTH'b0, pc_q3};
            trace_reg1 <= trace_reg0;
            trace_reg2 <= trace_reg1;
            trace_reg3 <= trace_reg2;
        end
    end
end
