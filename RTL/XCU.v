...
module XCU (
   ...
   XCU_monitorWRITEdata_q1, //goes to selected XCU wrSrcAdata
...
input  forceBreak;
input  sstep;
input  XCU_monitorREADreq; 
input  XCU_monitorWRITEreq;
input  [31:0] XCU_monitorRWaddrs_q0;
input  [1:0] XCU_monitorRWsize_q0;
output [63:0] XCU_monitorREADdata_q1;  //comes from selected XCU rdSrcBdata  
input  [63:0] XCU_monitorWRITEdata_q1;
...
reg [`XPCWIDTH-1:0] pc_q1;
reg [`XPCWIDTH-1:0] pc_q2;
...
reg XCU_monitorWRITEreq_q1;
reg [31:0] XCU_monitorRWaddrs_q1;
reg [31:0] XCU_monitorRWaddrs_q2;
...
reg tableRead_q1;
wire tableRead_q0;
assign tableRead_q0 = (SrcA_addrs_q0[31] && ~|SrcA_addrs_q0[30:`XPSIZE]) || (Dam_q0[1:0]==2'b10);
wire tableWrite_q2;
assign tableWrite_q2 = wrcycl && Dest_addrs_q2[31] && ~|Dest_addrs_q2[30:`XPSIZE];      
wire [63:0] tableReadData_q1;  


assign RM_q0[1:0] = RM_Attribute_on ? RM[1:0] : Instruction_q0_del[63:62];

assign Dest_addrs_q2 = ind_mon_write_q2 ? XCU_monitorRWaddrs_q2 : coreDest_addrs_q2;

assign rdSrcAdata = XCU_monitorWRITEreq_q1 ? XCU_monitorWRITEdata_q1 : (tableRead_q1 ? tableReadData_q1 : core_rdSrcAdata);

assign SrcA_addrs_q0 = ind_mon_read_q0 ? XCU_monitorRWaddrs_q0 : coreSrcA_addrs_q0;     
assign XCU_monitorREADdata_q1 = core_rdSrcAdata;
...
XCUbreakpoints xcubreakpoints(
    ...
    .monRWaddrs        (XCU_monitorRWaddrs_q0),
    .monRWsize         (XCU_monitorRWsize_q0),
    .monRDreq          (XCU_monitorREADreq  ),
    .monWRreq          (XCU_monitorWRITEreq )
    );
...
XCUultraProgRAM #(.ADDRS_WIDTH(`XPSIZE))       //dword addressable for program and table/constant storage
   PRAM0(      //program memory 
   .CLK       (CLK ),
   .wren      (tableWrite_q2 ),  
   .wraddrs   (Dest_addrs_q2[`XPSIZE-1:0]),             //writes to program ram are dword in address increments of one
   .wrdata    (wrsrcAdataSext),
   .rdenA     (tableRead_q0),
   .rdaddrsA  (SrcA_addrs_q0[`XPSIZE-1:0]),
   .rddataA   (tableReadData_q1),
   .rdenB     (rdcycl ),
   .rdaddrsB  (pre_PC[`XPSIZE-1:0]),
...
always @(posedge CLK) begin
    XCU_monitorREADreq_q1 <= XCU_monitorREADreq;
    XCU_monitorWRITEreq_q1 <= XCU_monitorWRITEreq;
    XCU_monitorRWaddrs_q1 <= XCU_monitorRWaddrs_q0;
    XCU_monitorRWaddrs_q2 <= XCU_monitorRWaddrs_q1;
end    
