...
parameter  XCU_FORCE_RESET_ADDRS   =  16'hFDD0;
parameter  XCU_FORCE_BREAK_ADDRS   =  16'hFDD2;
parameter  XCU_SSTEP_ADDRS         =  16'hFDD4;
parameter  XCU_PREEMPT_ADDRS       =  16'hFDD6;
...
assign XCU_monitorREADreq  = (SrcA_addrs_q0[15:4]==XCU_MON_REQUEST_ADDRS[15:4]);
assign XCU_monitorWRITEreq = (Dest_addrs_q0[15:4]==XCU_MON_REQUEST_ADDRS[15:4]);
assign XCU_monitorWRITE_ALL_req = (OPdest_q0[15:0]==XCU_MON_POKE_ALL_ADDRS[15:0]) && ~Ind_Dest_q0;
...
always @(*) begin
   ...
   else if (bitmatch) pre_PC = pc_q2 + {{`PCWIDTH-14{OPsrcB_q2[13]}}, OPsrcB_q2[13:0]};
   else if ((OPdest_q2[15:0]==PC_ADDRS[15:0]) && wrcycl && ~Ind_Dest_q2) pre_PC = wrsrcAdata[`PCWIDTH-1:0];  //absolute jump
