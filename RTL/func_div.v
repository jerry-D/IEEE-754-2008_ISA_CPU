...
input [9:0] NaN_del;
input [3:0] wraddrs, wraddrs_del, rdaddrsA, rdaddrsB;
...
reg [15:0] semaphor;  // one for each memory location   4 threads x 16 results each
...
assign div_by_0 = ~invalid && B_is_zero_del && wren_del_5 ;                  
