...
func_rtoi rtoi(  
    ...
    .NaN_del(NaN_payload),                                             
    .wren(wren_rtoi),
    .A_is_inexact_del(A_inexact_del_1),
    .A_is_infinite_del(A_is_infinite_del_1),
    .wraddrs_del(wraddrs_del_1[3:0]),
    .wraddrs(wraddrs[3:0]),
    .wrdataA(wrdataA_FP),
