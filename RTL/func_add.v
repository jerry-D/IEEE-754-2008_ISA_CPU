...
input [4:0] wraddrs;
input [4:0] wraddrs_del;
input [1:0] round_mode_del;
input Away_del;
input [4:0] rdaddrsA, rdaddrsB;
...
assign trunk_invalid = A_is_infinite_del && B_is_infinite_del && (A_sign_del ^ B_sign_del) && wren_del_2;    

assign operator_overflow = (R610[15:10] > 46) && wren_del_2 && (R610[18:17]==normal); 
...
RAM_func #(.ADDRS_WIDTH(5), .DATA_WIDTH(18))
    ram128_addclk(
    .CLK        (CLK      ),
    .wren       (wren_del_3),
    .wraddrs    (wraddrs_del),
